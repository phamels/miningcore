...
namespace MiningCore.Blockchain.Bitcoin
{
    ...
    public class BitcoinProperties
    {
        ...
        private static readonly IHashAlgorithm lyra2z330 = new Lyra2z330();
        ...
        private static readonly BitcoinCoinProperties lyra2z330Coin =
            new BitcoinCoinProperties(Math.Pow(2, 8), sha256S, lyra2z330, new DigestReverser(lyra2z330), "Lyra2z330");
